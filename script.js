...
(function () {
  ...
  if (nav && !nav.querySelector('.mobile-nav-footer')) {
    ...
    mobileFooter.innerHTML = [
      ...
      '  </a>',
      '  <a href="https://www.youtube.com/@TheAwadLawFirmPCGeorgia" target="_blank" rel="noopener noreferrer" aria-label="YouTube">',
...
(function () {
  ...
  function initPremiumTopBar() {
    ...
    topBar.innerHTML = [
      ...
      '      </a>',
      '      <a href="https://www.youtube.com/@TheAwadLawFirmPCGeorgia" target="_blank" aria-label="YouTube" class="social-icon-link">',
